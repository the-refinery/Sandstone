...
Source Database: designin_sandstonealpha
Target Host: localhost
Target Database: designin_sandstonealpha
Date: 9/2/2009 2:34:03 PM
*/
...
-- ----------------------------
DROP TABLE IF EXISTS `core_AccountMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ActionHistory`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ActionLogging`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ActionMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ActionNotification`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ActiveMerchantAccount`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_AddressMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_CreditCardTransactionMaster`;
CREATE TABLE `core_CreditCardTransactionMaster` (
  ...
  `AccountID` int(10) unsigned NOT NULL,
  `CIMpaymentProfileID` int(10) unsigned default NULL,
  `PartC` int(4) unsigned default NULL,
  `CIMcustomerProfileID` int(10) unsigned default NULL,
  ...
  KEY `IDX_CreditCardTransactionMaster_AccountID` (`AccountID`),
  CONSTRAINT `FK_CreditCardTransactionMaster_AccountMaster` FOREIGN KEY (`AccountID`) REFERENCES `core_AccountMaster` (`AccountID`),
...
-- ----------------------------
DROP TABLE IF EXISTS `core_CreditCardTransactionMessage`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_CreditCardTransactionTypeMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_CreditCardTypeMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_DBversion`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EmailMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EmailTypeMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EntityEmail`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EntityFile`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EntityImage`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EntityPhone`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_EntityTag`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_FileDownloadLog`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_FileMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_FileVersions`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ImageMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_KnowledgebaseArticleMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_KnowledgebaseSectionMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_MerchantAccountMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_MerchantAccountParameters`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_MessageCommentMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_MessageMaster`;
CREATE TABLE `core_MessageMaster` (
  ...
  `Content` mediumtext NOT NULL,
  `IsEmailOnComment` tinyint(4) default NULL,
  PRIMARY KEY  (`MessageID`),
...
-- ----------------------------
-- Table structure for core_PayPalTransactionMaster
-- ----------------------------
DROP TABLE IF EXISTS `core_PayPalTransactionMaster`;
CREATE TABLE `core_PayPalTransactionMaster` (
  `TransactionID` int(10) unsigned NOT NULL auto_increment,
  `AccountID` int(10) unsigned NOT NULL,
  `Token` varchar(75) NOT NULL,
  `CreateTimestamp` datetime NOT NULL,
  `GetDetailsTimestamp` datetime default NULL,
  `ProcessTimestamp` datetime default NULL,
  `Amount` decimal(15,4) NOT NULL,
  `IsSuccessful` tinyint(4) NOT NULL default '0',
  `PayerID` varchar(75) default NULL,
  `PayerStatus` varchar(75) default NULL,
  `PayPalTransactionNumber` varchar(75) default NULL,
  PRIMARY KEY  (`TransactionID`),
...
-- ----------------------------
DROP TABLE IF EXISTS `core_PhoneMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_PhoneTypeMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ReportFieldMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ReportMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SearchEntityMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SearchEntityProperty`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SEOkeywordMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SEOpageMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SystemMessageMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_SystemMessageReadLog`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_TagMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_ThumbnailMaster`;
...
-- ----------------------------
DROP TABLE IF EXISTS `core_TransactionCodeMaster`;
...
-- ----------------------------
-- Table structure for core_UserReadMessages
-- ----------------------------
DROP TABLE IF EXISTS `core_UserReadMessages`;
...
INSERT INTO `core_DBversion` VALUES ('4', '0', '5', '2009-08-28 15:30:00');
...
INSERT INTO `core_MerchantAccountMaster` VALUES ('1', 'PayPal Express Checkout', 'n/a', '1');

...
class LinkPointProcessor extends ProcessorBase
{
	...
	protected function BuildBilling()
	{
		...
		$returnValue['city'] = $this->_billingAddress->ZipCode->City;
		$returnValue['state'] = $this->_billingAddress->ZipCode->State->StateCode;
		$returnValue['zip'] = $this->_billingAddress->ZipCode->ZipCode;

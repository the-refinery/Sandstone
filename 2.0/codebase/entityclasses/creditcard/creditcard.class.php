...
class CreditCard extends Module
{
	...
	public function ProcessSale($Amount, $MerchantAccountID = null)
	{
		
		//Process the Sale
		$merchantAccount = new MerchantAccount($MerchantAccountID, $this->_conn);
		$newTransaction = $merchantAccount->ProcessSale($this, $Amount);

...
class Dataset extends Module
{
	...
	public function __construct($ds=null, $ClassName=null, $KeyProperty=null)
	{
		$this->_objects = array();
		$this->_keys = Array();
		$this->_currentIndex = 0;
		
		if (is_set($ds) && is_set($ClassName) && is_set($KeyProperty))
		{
			$this->Load($ds, $ClassName, $KeyProperty);
		}
	...
	public function Load($ds, $ClassName, $KeyProperty)
	{

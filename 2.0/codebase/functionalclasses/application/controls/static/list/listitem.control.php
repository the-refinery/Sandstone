...
class ListItemControl extends StaticBaseControl
{
   	...
   	public function __construct()
	{
		...
		$this->_bodyStyle->AddClass('list_item');
	}
	...
	public function RenderControlBody()
	{
		...
		$returnValue .=  "<li {$id} {$this->_bodyStyle->Classes} {$this->_bodyStyle->Style}>";

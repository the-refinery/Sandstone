...
class DatePickerControl extends BaseControl
{
    ...
    public function __construct()
	{
		...
		$this->Message->BodyStyle->AddClass('datepicker_message');
		$this->Label->BodyStyle->AddClass('datepicker_label');
	...
	protected function RenderControlBody()
	{
		...
		$returnValue .= $this->Month->__toString();
		$returnValue .= $this->Day->__toString();
		$returnValue .= $this->Year->__toString();
	...
	protected function RenderLabel()
	{
		...
		$this->Label->TargetControlName = $this->Month->Name;
	...
	protected function SetupControls()
	{
		...
		$this->Month->ControlStyle->AddStyle("display:inline;");
		$this->Month->Effects->Scope= $this->_effects->Scope;

		$this->Day = new DropDownControl();
		$this->Day->ControlStyle->AddClass("datepicker_dayitem");
		$this->Day->ControlStyle->AddStyle("display:inline;");
		$this->Day->Effects->Scope= $this->_effects->Scope;

   		$this->Year = new DropDownControl();
		$this->Year->ControlStyle->AddClass("datepicker_yearitem");
		$this->Year->ControlStyle->AddStyle("display:inline;");
		$this->Year->Effects->Scope= $this->_effects->Scope;

...
class QRimage {
  ...
  //----------------------------------------------------------------------
  public static function rawImage($frame,  $pixelPerPoint = 4, $outerFrame = 4) 
  {
...
class QRencode {
  ...
  public function encodeRawImage($intext) 
  {
    try {
      ...
      $image = QRimage::rawImage($tab, min(max(1, $this->size), $maxSize), $this->margin);

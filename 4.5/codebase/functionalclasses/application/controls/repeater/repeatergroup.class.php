...
class RepeaterGroup extends ControlContainer
{
    ...
    public function __construct($Name, $Property, $Repeater, $CallbackObject, $CallbackMethodName)
    {
        parent::__construct();
    ...
    public function AddGroup($Name, $Property, $Repeater, $CallbackObject, $CallbackMethodName)
	{
		$returnValue = false;
		...
		if (strlen($Property) > 0)
		{
			...
			{
				$this->_subGroup->AddGroup($Name, $Property, $Repeater, $CallbackObject, $CallbackMethodName);
			}
			else
			{
				$this->_subGroup = new RepeaterGroup($Name, $Property, $Repeater, $CallbackObject, $CallbackMethodName);	
			}

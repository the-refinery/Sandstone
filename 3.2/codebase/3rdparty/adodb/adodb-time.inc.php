...
function adodb_date2($fmt, $d=false, $is_gmt=false)
{
	if ($d !== false) {
		...
		// h-m-s-MM-DD-YY
		if (!is_set($rr[5])) $d = adodb_mktime(0,0,0,$rr[2],$rr[3],$rr[1],false,$is_gmt);
...
static $daylight;
	...
	if (!is_set($daylight)) $daylight = function_exists('adodb_daylight_sv');

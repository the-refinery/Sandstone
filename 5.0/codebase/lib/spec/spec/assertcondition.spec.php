...
class AssertConditionSpec extends DescribeBehavior
{
	...
	{
		$assert = new AssertCondition(5, "ItShouldntMatter", $this);
	...
	{
		$assert = new AssertCondition(2, "ItShouldntMatter", $this);
	...
	{
		$assert = new AssertCondition(true, "ItShouldntMatter", $this);
